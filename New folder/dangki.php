...
<script>
	...
	function validate()
	{
		...
		{
			errUser.innerHTML="1 đến 16 kí tự!";	
			document.getElementById("txtUser").style.border="2px solid red";	
		}
		//mat khau
		if(pass.length==0)
		...
		{
			errMatKhauNhapLai.innerHTML="Không khớp!";
		document.getElementById("txtNhapLaiMatKhau").style.border="2px solid red";	
		}else
		{
		...
		}else
		{
			...
			{
				errTen.innerHTML="Sai định dạng!";	
				document.getElementById("txtTen").style.border="2px solid red";
			}
		}
		//ngay sinh
...
<body >
	<?php 
		if (isset($_GET['err'])) {
			if ($_GET['err'] == '1') {
				?>
				<script>
					alert("Đăng ký thất bại: trùng tên đăng nhập!");
				</script>
				<?php
			}
		}
	...
	<form method="POST" action="dangkiProcess.php">
		<center>
	        <table>
	            <tr>
	                <th colspan="3" style="font-size: 24px; color: 	white;">Thông Tin Đăng Nhập</th>
	            </tr>
	            <tr>
	                <td >Tên Đăng Nhập:</td>
	         ...
	         Yêu cầu nhập
	            ...
	            <tr >
	                <th colspan="3"><input type="button" id="frm" value="Đăng Ký" style="height: 30px;font-size: 16px; width: 140px; background: linear-gradient(to right, #fc00ff, #00dbde);" onclick="validate()"/></th>
